    ...
    <div class="max-w-2xl mx-auto">
      ...
      <div v-else-if="sale" id="receipt-content" class="bg-white rounded-xl shadow-sm border border-zinc-200 overflow-hidden">
          ...
          <div class="flex items-start justify-between">
            <div class="flex items-center gap-4">
              <div class="w-14 h-14 sm:w-16 sm:h-16 bg-white rounded-xl flex items-center justify-center shadow-lg">
                <img src="/images/logo-1.png" alt="H2O" class="w-10 h-10 sm:w-12 sm:h-12 object-contain" />
              </div>
              <div>
                <h1 class="text-xl sm:text-2xl font-bold">H2O</h1>
        ...
        <div class="px-6 sm:px-8 py-4 bg-zinc-100 text-center">
          ...
          <p class="text-xs text-zinc-400 mt-1">Generated by H2O - {{ new Date().toLocaleDateString() }}</p>
        </div>
      </div>
    </div>
  </div>
  ...
  return `
    ...
    <body>
      ...
      <div class="footer">
        ...
        <p>Generated by H2O - ${new Date().toLocaleDateString()}</p>
      </div>
    </body>
    </html>
  `;
